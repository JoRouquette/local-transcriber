...
public partial class MainWindow : Window
{
    ...
    private void Tray_StartService(object sender, RoutedEventArgs e) => Safe(WindowsServiceControl.Start);
    private void Tray_StopService(object sender, RoutedEventArgs e) => Safe(WindowsServiceControl.Stop);
    ...
    {
        try { action(); } catch { /* geste tray best-effort */ }
    }
}
